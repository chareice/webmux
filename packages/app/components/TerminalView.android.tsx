...
html,body{width:100%;height:100%;overflow:hidden;background:#112a45;}
...
(function(){
  var term = new Terminal({
    ...
    theme: {
      ...
      black: '#0a1929', red: '#ff6b6b', green: '#00d4aa',
      yellow: '#ffd93d', blue: '#4dabf7', magenta: '#cc5de8',
      cyan: '#22b8cf', white: '#e0e8f0',
    },
    cursorBlink: true,
    scrollback: 5000,
