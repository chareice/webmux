...
1. **action:** In a desktop browser session, open the app, click the sidebar's "viewing" pill to take control, and open a new terminal via the sidebar's ＋ button, `⌃B c`, or the empty-state "Start terminal" button.
