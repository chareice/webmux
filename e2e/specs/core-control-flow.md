...
2. **action:** In browser session A, click the "viewing" pill in the sidebar's bottom control area to take control, then click "Start terminal" in the empty state (or the sidebar's ＋ button (new-session panel → terminal) / press `⌃B c`).
